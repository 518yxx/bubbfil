...
<html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
	<head>
		...
		<?php wp_head(); ?>
		<?php wp_enqueue_script( 'html5media',  get_template_directory_uri() . '/core/js/html5media.js', true ); ?>
		<?php wp_enqueue_script( 'user-scripts-main',  get_template_directory_uri() . '/core/js/bubbfil.js', array( 'jquery' ), true ); ?>
	</head>
...
<?php responsive_header(); // before header hook ?>
	...
	<div id="header">
		...
		<?php if( get_header_image() != '' ) : ?>
			...
			<div id="logo">
				<a class="logo-aera" href="<?php echo home_url( '/' ); ?>">
					<div class="site-logo">
					...
					<div class="site-description">
						...
						<h2 class="site-subtitle"><?php echo get_bloginfo('description','display') ?></h2>
					</div>
				</a>
			</div><!-- end of #logo -->
...
<img src="/wp-content/uploads/2014/11/banner.jpg" width=960 height=200>
<?php } ?>
